...
| 3 | `UCliffImportCommandlet` | Reads `SourcePath` / `ManifestName` / `ArchiveName` / `NativeCulture` / `CulturesToGenerate` plus `ClifFilePath` (repeatable) or `CliffDirectory` + `CliffImportCulture` |

...
Every AI-related setting lives under **Edit > Project Settings > Plugins > CLIFF Localization Suite > AI Translation**. This page explains what each parameter does and how to tune it; the complete field list is in the [settings reference](../../../reference/settings/settings).
...
- The console command `CliffLocalizationSuite.AI.TestConnection`

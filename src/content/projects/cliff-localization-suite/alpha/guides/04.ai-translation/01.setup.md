...
所有 AI 相关设置都在 **编辑 > 项目设置 > 插件 > CLIFF Localization Suite > AI Translation**。本文说明每个参数的作用与调参建议；字段的完整清单见 [设置参考](../../../reference/settings/settings)。
...
- 设置面板的 **测试连接** 按钮
- 控制台命令 `CliffLocalizationSuite.AI.TestConnection`

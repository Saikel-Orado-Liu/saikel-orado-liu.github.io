...
date: 2026-09-11
excerpt: "What a CLIFF import actually writes: field ownership in manifest / archive, cliff.* metadata, effective-source synchronisation, empty-translation guards, compilation and live refresh."
---
...
| `ClifFilePath` | ✅* | Absolute path of a single `.cliff` (may appear more than once) |
...
\* `ClifFilePath` and `CliffDirectory` are mutually exclusive.

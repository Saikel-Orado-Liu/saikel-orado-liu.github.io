---
title: "CLIFF in Five Minutes"
date: 2026-09-11
excerpt: "CLIFF 1.0 in one page: file skeleton, header fields, groups and inheritance, value shapes, closed vocabularies and validation."
---
...
> [!WARNING]
> Writing `emotion: calm` (missing brackets), `type: "label"` (a quoted tag) or `reference: "src/ui.cpp:42"` (a list as a scalar) are all **validity errors** in CLIFF 1.0. Multi-line text uses adjacent string concatenation or `\n`; there is no `|`-style block scalar.

...
title: "Installation"
date: 2026-09-11
excerpt: "Installing, enabling and verifying the CLIFF Localization Suite plugin."
---
...
1. Search for "CLIFF Localization Suite" on Fab, or open the [product page](https://www.fab.com/listings/b53f5be1-1fd8-4ffb-ba33-2a1a3fa2cc5a)
...
| Category | Contents |
|:---|:---|
| **Identity** | `CLIFF Namespace`: the project identifier used in CLIFF headers (lowercase kebab-case) |

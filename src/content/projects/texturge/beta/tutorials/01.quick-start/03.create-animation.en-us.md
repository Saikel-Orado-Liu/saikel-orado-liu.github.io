...
`UTextAnimationBlueprint` is Texturge's core authoring asset. Each animation Blueprint holds a set of `UGlyphAnimation` curve assets, and the Blueprint variables declared by the designer become animation parameters (this is how preset parameters like `Duration` / `CharDelay` are implemented).
...
<figure class="img-placeholder"><figcaption>images/create-text-animation-blueprint.png — Content Browser context menu screenshot: Texturge submenu expanded with "Text Animation Blueprint" highlighted, asset named TAB_Wave</figcaption></figure>
...
<figure class="img-placeholder"><figcaption>images/editor-layout.png — Animation blueprint editor panoramic screenshot: animation list panel on the left, designer viewport showing "Hello Texturge" preview text in the center, Sequencer timeline and details panel on the right, mode switcher (Designer/Graph) and Compile button in the toolbar</figcaption></figure>
...
<figure class="img-placeholder"><figcaption>images/umg-widget-setup.png — UMG designer screenshot: UAnimatedTextBlock selected on canvas, Details panel showing Text property ("Hello World"), TextAnimationBlueprint property (TAB_Wave) and Parameter Overrides property</figcaption></figure>

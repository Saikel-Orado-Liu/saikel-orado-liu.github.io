...
<figure class="img-placeholder"><figcaption>images/plugin-folder-location.png — Project directory screenshot: Plugins/Texturge folder (with Source, Content, Texturge.uplugin and Binaries), project root highlighted in the left explorer tree</figcaption></figure>
...
<figure class="img-placeholder"><figcaption>images/plugin-manager-checkbox.png — Plugin Manager screenshot: search box with "Texturge", the Texturge plugin row highlighted and checked, Restart Now button at bottom right</figcaption></figure>
...
<figure class="img-placeholder"><figcaption>images/project-settings-panel.png — Project Settings screenshot: Texturge category under Plugins group in the left tree, right side showing an empty settings page (no configuration items)</figcaption></figure>
...
<figure class="img-placeholder"><figcaption>images/umg-palette-animated-text.png — UMG widget designer screenshot: "Palette" panel search box with "Animated Text Block", the widget highlighted in the list, an instance placed on the canvas on the right</figcaption></figure>
